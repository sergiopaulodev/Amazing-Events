...
for (let i = 0; i <= 0; i++){
    ...
    imgCard.src = pastEvent[i].image
    
    let titleCard = document.getElementById('title-card-0');
    titleCard.innerHTML = pastEvent[i].name
    
    let descriptionCard = document.getElementById('p-card-0')
    descriptionCard.innerHTML = pastEvent[i].description
    
    let price = document.getElementById('price-0')
    price.innerHTML = `Price: $${pastEvent[i].price}`;
}
